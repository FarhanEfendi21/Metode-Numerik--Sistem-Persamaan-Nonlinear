# -*- coding: utf-8 -*-
"""Metode Numerik - Sistem Persamaan Nonlinear.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Gtcb_GbEd8iyCQrxhhoe5N6X0gPHMzCW
"""
...
def metode_secant(x0, y0, epsilon, max_iter=1000):
    """Metode Secant (aproksimasi turunan)"""
    print("\n" + "="*80)
    print("METODE 4: SECANT")
    print("="*80)
    print(f"Tebakan awal: x0 = {x0}, y0 = {y0}")
    print(f"Toleransi: ε = {epsilon}")
    print("Formula: Aproksimasi turunan tanpa menghitung turunan eksplisit")
    print()
...
def main():
    ...
    print("\n3. NEWTON-RAPHSON:")
    print("   - Menggunakan matriks Jacobian dan turunan parsial")
    print("   - Konvergensi kuadratik (sangat cepat)")
    print("\n4. SECANT:")
    print("   - Aproksimasi turunan tanpa menghitung turunan eksplisit")
    print("   - Alternatif untuk Newton-Raphson")
    print("="*80)
